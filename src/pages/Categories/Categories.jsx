...
import EditFormPage from "./EditCategoriesForm";
...
export default function Categories() {
    ...
    const handleDelete = async (id) => {
        modal.confirm({
            ...
            onOk: async () => {
                try {
                    await deleteCategory(id); // Replace with actual API call
    ...
    // loading===false? fetchCategories() : console.log("")
    ...
    return (
        ...
        <div className={'relative'}>
            ...
            <div  className={'w-full '}>
                <Header title={'Kategoriyalar haqida ma’lumotlar'}/>
            </div>

            {
                editActive?
                    <div className={'p-5'}>
                        <EditFormPage id={editingCategory}/>
                    </div>

                    :
                    <div className={style.container}>
                        <div className={style.subHeader}>
                            <p>Common: {data?.length} categories</p>
