...
import EditFormPage from "./EditSizeForm";
...
export default function Sizes() {
    ...
    const handleDelete = async (id) => {
        modal.confirm({
            ...
            onOk: async () => {
                try {
                    await deleteSize(id); // Replace with actual API call
                    messageApi.success(" Size deleted successfully!");
                } catch (error) {
                    messageApi.error(" 🔥 Failed to delete size.");
                } finally {
                    fetchSizes()
                }
            },
    ...
    // loading===false? console.log('nnigga') : console.log("")
    ...
    return (
        ...
        <div className={'relative'}>
            ...
            <div  className={'w-full '}>
                <Header title={'Razmerlar haqida ma’lumotlar'}/>
            </div>

            {
                editActive?
                    <div className={'p-5'}>
                        <EditFormPage id={editingSize}/>
                    </div>
