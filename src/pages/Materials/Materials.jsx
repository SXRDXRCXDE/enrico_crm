...
import EditFormPage from "./EditMaterialsForm";
...
export default function Materials() {
    ...
    // loading===false? fetchMaterial() : console.log("")
    ...
    return (
        ...
        <div className={'relative'}>
            ...
            <div  className={'w-full '}>
                <Header title={'Materiallar haqida ma’lumotlar'}/>
            </div>

            {
                editActive?
                    <div className={'p-5'}>
                        <EditFormPage id={editingMaterial}/>
                    </div>

                    :
                    <div className={style.container}>
                        <div className={style.subHeader}>
                            <p>Common: {data?.length} materials</p>
